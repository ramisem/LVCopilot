...
public class Test {
    public static void main(String[] args) {
        try {
            ...
            Obj obj = new Obj("A string, a number, and a boolean", 42.0, true);
            ...
            String s = jj.object().key("foo").value("bar").key("baz").array().object().key("quux").value("Thanks, Josh!").endObject().endArray().endObject().toString();
            ...
            System.out.println("");
            j = new JSONObject("/*comment*/{foo: [true, false,9876543210,    0.0, 1.00000001,  1.000000000001, 1.00000000000000001, .00000000000000001, 2.00, 0.1, 2e100, -32,[],{}, \"string\"],   to   : null, op : 'Good',ten:10} postfix comment");
            j.put("String", "98.6");
