...
public interface UnApplySDISpec {
    public static final String LABVANTAGE_CVS_ID = "$Revision: 50515 $";
    public static final String ID = "UnapplySDISpec";
    ...
    public static final String PROPERTY_SPECID = "specid";
    public static final String PROPERTY_SPECVERSIONID = "specversionid";
