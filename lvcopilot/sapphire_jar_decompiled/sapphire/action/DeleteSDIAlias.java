...
public interface DeleteSDIAlias {
    public static final String ID = "DeleteSDIAlias";
    ...
    public static final String PROPERTY_ALIASID = "aliasid";
    public static final String PROPERTY_ALIASTYPE = "aliastype";
