...
public interface AddDataItem {
    public static final String ID = "AddDataItem";
    ...
    public static final String PROPERTY_NUMREPLICATE = "numreplicate";
    public static final String PROPERTY_PARAMLISTCHECK = "paramlistcheck";
