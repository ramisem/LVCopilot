...
public interface SyncSDIWIStatus {
    public static final String ID = "SyncSDIWIStatus";
    ...
    public static final String PROPERTY_SYNCSDIWORKITEMGROUPSTATUSONLY = "syncsdiworkitemgroupstatusonly";
    ...
    public static final String PROPERTY_GROUPINSTANCE = "groupinstance";
