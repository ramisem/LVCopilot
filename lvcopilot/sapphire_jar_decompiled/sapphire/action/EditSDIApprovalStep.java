...
public interface EditSDIApprovalStep {
    public static final String ID = "EditSDIApprovalStep";
    ...
    public static final String PROPERTY_MANDATORY = "mandatoryflag";
    public static final String PROPERTY_USERSEQUENCE = "usersequence";
