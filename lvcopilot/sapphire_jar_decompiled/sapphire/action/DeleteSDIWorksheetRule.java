...
public interface DeleteSDIWorksheetRule {
    public static final String ID = "DeleteSDIWorksheetRule";
    ...
    public static final String PROPERTY_WORKSHEETINSTANCE = "worksheetinstance";
