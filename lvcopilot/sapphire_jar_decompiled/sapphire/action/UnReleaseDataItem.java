...
public interface UnReleaseDataItem {
    public static final String ID = "UnReleaseDataItem";
    ...
    public static final String PROPERTY_ALLOWMANDATORYNULLS = "allowmandatorynulls";
