...
extends BodyTagSupport {
    ...
    PropertyList attibutes = new PropertyList();
    ...
    protected void writeBodyContent() throws JspTagException {
        try {
    ...
    public void goErrorPage(String errormsg, String extraparameters) throws JspTagException {
        ...
        if (this._errorpage != null && this._errorpage.length() > 0) {
            String rc = "/" + this.pageContext.getServletContext().getInitParameter("RequestControllerName") + "?command=file&file=" + this._errorpage;
