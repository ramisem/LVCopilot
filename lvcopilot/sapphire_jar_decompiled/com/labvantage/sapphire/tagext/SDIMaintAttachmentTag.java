...
import com.labvantage.sapphire.pageelements.maint.MaintAttachment;
import com.labvantage.sapphire.tagext.BaseSDIMaintTag;
import javax.servlet.jsp.JspTagException;
import sapphire.tagext.SDITagInfo;
import sapphire.xml.PropertyList;

public class SDIMaintAttachmentTag
extends BaseSDIMaintTag {
    @Override
    public void doTag(SDITagInfo sdiInfo) throws JspTagException {
        MaintAttachment element = new MaintAttachment(this.pageContext, sdiInfo, this.getConnectionId());
        ...
        if (properties != null) {
            ...
            this.write("TAG ERROR: sdimaintattachment tag properties not found through id: " + this.id);
        }
    }
}
