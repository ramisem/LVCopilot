...
public class AlwaysLevelRuleProcessor
implements RuleTypeProcessor {
    ...
    public String getSummary(String ruledefinition, QueryProcessor qp, TranslationProcessor tp) throws SapphireException {
        ...
        try {
            ...
            summarytext.append(". " + tp.translate("Set Level to") + " ").append("<font size=\"1\" face=\"Verdana\" color=\"blue\">").append(tp.translate(levelDisplayValue)).append(" ").append(tp.translate(ruletype)).append("</font>");
        }
