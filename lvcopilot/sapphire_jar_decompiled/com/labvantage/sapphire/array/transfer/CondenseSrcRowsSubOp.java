...
public class CondenseSrcRowsSubOp
extends BaseSubOperation {
    ...
    public ArrayList<TransferMap> generateMap(HashMap<String, String> subOpProperties, QueryProcessor queryProcessor) throws SapphireException {
        ...
        ArrayList<TransferMap> transferMap = evalRules.condenseArray("CondenseSourceRows", subOpProperties.get("sourcearraytypeid"), subOpProperties.get("targetarraytypeid"), "", "", Boolean.valueOf(subOpProperties.get("transpose")), queryProcessor);
        return transferMap;
    }
