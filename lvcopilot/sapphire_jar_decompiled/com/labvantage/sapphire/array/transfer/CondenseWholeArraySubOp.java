...
public class CondenseWholeArraySubOp
extends BaseSubOperation {
    ...
    public ArrayList<TransferMap> generateMap(HashMap<String, String> subOpProperties, QueryProcessor queryProcessor) throws SapphireException {
        ...
        ArrayList<TransferMap> transferMap = evalRules.condenseArray("WholeArray", subOpProperties.get("sourcearraytypeid"), subOpProperties.get("targetarraytypeid"), subOpProperties.get("direction"), subOpProperties.get("startpos"), Boolean.valueOf(subOpProperties.get("transpose")), queryProcessor);
        return transferMap;
    }
