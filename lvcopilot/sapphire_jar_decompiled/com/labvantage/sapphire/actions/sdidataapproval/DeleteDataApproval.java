...
public class DeleteDataApproval
extends BaseAction
implements sapphire.action.DeleteDataApproval {
    static final String LABVANTAGE_CVS_ID = "1: 1.1 $";
    public static final String ID = "DeleteDataApproval";
    ...
    public void processAction(PropertyList properties) throws SapphireException {
        ...
        for (int x = 0; x < keyid1Arr.length; ++x) {
            ...
            if (numberOfSdiDataApprovals > 0) {
                ...
                throw new SapphireException("INVALID_PROPERTY", this.getTranslationProcessor().translate("Dataset: [sdcid], [keyid1], [keyid2], [paramlistid], [paramlistversionid], [variantid], [dataset]  is approved, can not be deleted.", token));
            }
            ...
            sql.append(" AND VARIANTID=" + safeSQLKeyClause.addVar(variantId) + " AND DATASET=" + safeSQLKeyClause.addVar(dataSet));
            this.logger.info("Deleting SDIDATAAPPROVAL records: " + sql.toString());
