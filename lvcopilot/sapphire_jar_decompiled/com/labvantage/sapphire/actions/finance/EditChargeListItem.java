...
public class EditChargeListItem
extends BaseFinanceAction
implements sapphire.action.EditChargeListItem {
    @Override
    public void processAction(PropertyList properties) throws SapphireException {
        try {
            ...
            if (StringUtil.getLen(value) > 0L) {
                ...
                String[] rowvalues = StringUtil.split(value, ";");
            ...
            for (int i = 0; i < ii; ++i) {
                ...
                if (!(lastkeyid1.equals(keyid1) && lastkeyid2.equals(keyid2) && lastkeyid3.equals(keyid3))) {
                    ...
                    catch (ActionException sapphireException) {
                        throw new SapphireException("PROCESSACTION_FAILED", "Action AddSDI failed : " + ErrorUtil.extractMessageFromException(sapphireException, ErrorUtil.isUserAdmin(this.getConnectionId())), sapphireException);
                    }
                }
