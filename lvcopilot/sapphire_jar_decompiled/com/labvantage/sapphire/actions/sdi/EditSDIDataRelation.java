...
public class EditSDIDataRelation
extends BaseAction
implements sapphire.action.EditSDIDataRelation {
    ...
    public void processAction(PropertyList properties) throws SapphireException {
        ...
        input.addColumnValues("paramlistid", 0, properties.getProperty("paramlistid"), PROPERTY_SEPARATOR);
        input.addColumnValues("paramlistversionid", 0, properties.getProperty("paramlistversionid"), PROPERTY_SEPARATOR);
        input.addColumnValues("variantid", 0, properties.getProperty("variantid"), PROPERTY_SEPARATOR);
        input.addColumnValues("dataset", 1, properties.getProperty("dataset"), PROPERTY_SEPARATOR);
        ...
        if ((sourceKeyid2 = properties.getProperty("sourcekeyid2")) != null && sourceKeyid2.length() > 0) {
            input.addColumnValues("sourcekeyid2", 1, sourceKeyid2, PROPERTY_SEPARATOR);
        }
        ...
        String[] keyColumns = new String[]{"sdcid", "keyid1", "keyid2", "keyid3", "paramlistid", "paramlistversionid", "variantid", "dataset", "relationid"};
        DataSetUtil.update(this.database, input, "sdidatarelation", keyColumns);
    }
