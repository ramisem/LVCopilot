...
public class DeleteSDCAttribute
extends BaseAction {
    ...
    public void processAction(PropertyList properties) throws SapphireException {
        ...
        if (sdcid.length() > 0) {
            ...
            if (attributeid.length() <= 0) {
                throw new SapphireException("No Attribute Id/AttributeDef Id provided.");
            }
        } else {
            throw new SapphireException("No SDC Id/BasedOnId provided.");
        }
        ...
        this.getActionProcessor().processAction("DeleteSDI", "1", properties, false);
    }
}
