...
extends BaseAction {
    ...
    public void processAction(PropertyList properties) throws SapphireException {
        ...
        if (sdcid.length() > 0) {
            ...
            throw new SapphireException("No SDC Id or BasedOnId provided.");
        }
        ...
        this.getActionProcessor().processAction("AddSDI", "1", properties, false);
    }
}
