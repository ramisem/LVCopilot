...
public class ExportTaskDef
extends BaseAction
implements sapphire.action.ExportTaskDef,
TransferAction {
    ...
    public void processAction(PropertyList props) throws SapphireException {
        String taskdefid = props.getProperty("taskdefid");
        String taskdefversionid = props.getProperty("taskdefversionid");
        String taskdefvariantid = props.getProperty("taskdefvariantid");
        ...
        SDITransfer sdi = new SDITransfer("LV_TaskDef");
        sdi.setKeyid1(taskdefid);
        sdi.setKeyid2(taskdefversionid);
        sdi.setKeyid3(taskdefvariantid);
        ...
        if (props.getProperty("taskexists").equals("replace")) {
            sdi.setDetailForceUpdate("true");
            sdi.setPrimaryForceUpdate("true");
        }
        sdi.setTransferOption("includeconnectortypes", props.getProperty("includeconnectortypes", "Y"));
        ...
        try {
            ...
            throw new SapphireException("Failed to export task " + LV_TaskDef.getText(taskdefid, taskdefversionid, taskdefvariantid) + ". Reason: " + ErrorUtil.extractMessageFromException(e, ErrorUtil.isUserAdmin(this.getConnectionId())), e);
        }
        finally {
            try {
                if (zipOut != null) {
    ...
    public PropertyList convertWizardProperties(PropertyList wizardProps, String connectionid) throws Exception {
        ...
        actionProps.setProperty("taskdefid", wizardProps.getProperty("keyid1"));
        actionProps.setProperty("taskdefversionid", wizardProps.getProperty("keyid2"));
        actionProps.setProperty("taskdefvariantid", wizardProps.getProperty("keyid3"));
