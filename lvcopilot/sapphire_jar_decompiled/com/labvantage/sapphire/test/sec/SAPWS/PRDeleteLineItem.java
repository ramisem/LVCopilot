...
public class PRDeleteLineItem
implements Serializable {
    private String ZSEC_DATA;
    private Object __equalsCalc = null;
    private boolean __hashCodeCalc = false;
    private static TypeDesc typeDesc = new TypeDesc(PRDeleteLineItem.class, true);

    public PRDeleteLineItem() {
    }

    public PRDeleteLineItem(String ZSEC_DATA) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PRDeleteLineItem)) {
            return false;
        }
        PRDeleteLineItem other = (PRDeleteLineItem)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    static {
        typeDesc.setXmlType(new QName("http://labvantage.com/xi/SEC/R5/DeleteLineItemOfPR/1.0", "PRDeleteLineItem"));
