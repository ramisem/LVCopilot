...
public class PRDeleteLineItem_OUTBindingStub
extends Stub
implements PRDeleteLineItem_OUT {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.setName("PRDeleteLineItem_OUT");
        ParameterDesc param = new ParameterDesc(new QName("http://labvantage.com/xi/SEC/R5/DeleteLineItemOfPR/1.0", "PRDeleteLineItem"), 1, new QName("http://labvantage.com/xi/SEC/R5/DeleteLineItemOfPR/1.0", "PRDeleteLineItem"), PRDeleteLineItem.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://labvantage.com/xi/SEC/R5/DeleteLineItemOfPR/1.0", "Result"));
        oper.setReturnClass(Result.class);
        oper.setReturnQName(new QName("http://labvantage.com/xi/SEC/R5/DeleteLineItemOfPR/1.0", "Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        PRDeleteLineItem_OUTBindingStub._operations[0] = oper;
    }

    public PRDeleteLineItem_OUTBindingStub() throws AxisFault {
        this(null);
    }

    public PRDeleteLineItem_OUTBindingStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public PRDeleteLineItem_OUTBindingStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://labvantage.com/xi/SEC/R5/DeleteLineItemOfPR/1.0", "PRDeleteLineItem");
        this.cachedSerQNames.add(qName);
        Class cls = PRDeleteLineItem.class;
        this.cachedSerClasses.add(cls);
        this.cachedSerFactories.add(beansf);
        this.cachedDeserFactories.add(beandf);
        qName = new QName("http://labvantage.com/xi/SEC/R5/DeleteLineItemOfPR/1.0", "Result");
        this.cachedSerQNames.add(qName);
        cls = Result.class;
        this.cachedSerClasses.add(cls);
        this.cachedSerFactories.add(beansf);
    ...
    protected Call createCall() throws RemoteException {
        try {
            ...
            PRDeleteLineItem_OUTBindingStub pRDeleteLineItem_OUTBindingStub = this;
            synchronized (pRDeleteLineItem_OUTBindingStub) {
                if (this.firstCall()) {
    ...
    @Override
    public Result PRDeleteLineItem_OUT(PRDeleteLineItem PRDeleteLineItem2) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "PRDeleteLineItem_OUT"));
        this.setRequestHeaders(_call);
        this.setAttachments(_call);
        Object _resp = _call.invoke(new Object[]{PRDeleteLineItem2});
    ...
    static {
        PRDeleteLineItem_OUTBindingStub._initOperationDesc1();
    }
}
