...
public class PRUpdate_OUTBindingStub
extends Stub
implements PRUpdate_OUT {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.setName("PRUpdate_OUT");
        ParameterDesc param = new ParameterDesc(new QName("http://labvantage.com/xi/SEC/R5/PRUpdate/1.0", "PRUpdate"), 1, new QName("http://labvantage.com/xi/SEC/R5/PRUpdate/1.0", "PRUpdate"), PRUpdate.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://labvantage.com/xi/SEC/R5/PRUpdate/1.0", "Result"));
        oper.setReturnClass(Result.class);
        oper.setReturnQName(new QName("http://labvantage.com/xi/SEC/R5/PRUpdate/1.0", "Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        PRUpdate_OUTBindingStub._operations[0] = oper;
    }

    public PRUpdate_OUTBindingStub() throws AxisFault {
        this(null);
    }

    public PRUpdate_OUTBindingStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public PRUpdate_OUTBindingStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://labvantage.com/xi/SEC/R5/PRUpdate/1.0", "PRUpdate");
        this.cachedSerQNames.add(qName);
        Class cls = PRUpdate.class;
        this.cachedSerClasses.add(cls);
        this.cachedSerFactories.add(beansf);
        this.cachedDeserFactories.add(beandf);
        qName = new QName("http://labvantage.com/xi/SEC/R5/PRUpdate/1.0", "Result");
        this.cachedSerQNames.add(qName);
        cls = Result.class;
        this.cachedSerClasses.add(cls);
        this.cachedSerFactories.add(beansf);
    ...
    protected Call createCall() throws RemoteException {
        try {
            ...
            PRUpdate_OUTBindingStub pRUpdate_OUTBindingStub = this;
            synchronized (pRUpdate_OUTBindingStub) {
                if (this.firstCall()) {
    ...
    @Override
    public Result PRUpdate_OUT(PRUpdate PRUpdate2) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "PRUpdate_OUT"));
        this.setRequestHeaders(_call);
        this.setAttachments(_call);
        Object _resp = _call.invoke(new Object[]{PRUpdate2});
    ...
    static {
        PRUpdate_OUTBindingStub._initOperationDesc1();
    }
}
