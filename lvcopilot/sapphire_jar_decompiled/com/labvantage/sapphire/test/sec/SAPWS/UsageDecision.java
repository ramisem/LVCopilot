...
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(UsageDecision.class, true);

    public UsageDecision() {
    }

    public UsageDecision(String ZSEC_DATA) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof UsageDecision)) {
            return false;
        }
        UsageDecision other = (UsageDecision)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    static {
        typeDesc.setXmlType(new QName("http://labvantage.com/xi/SEC/R5/UsageDecision/1.0", "UsageDecision"));
