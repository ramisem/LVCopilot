...
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(PRCreate.class, true);

    public PRCreate() {
    }

    public PRCreate(String ZSEC_DATA) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PRCreate)) {
            return false;
        }
        PRCreate other = (PRCreate)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    static {
        typeDesc.setXmlType(new QName("http://labvantage.com/xi/SEC/R5/PRCreate/1.0", "PRCreate"));
