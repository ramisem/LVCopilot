...
public class ResultRecord_OUTBindingStub
extends Stub
implements ResultRecord_OUT {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.setName("ResultRecord_OUT");
        ParameterDesc param = new ParameterDesc(new QName("http://labvantage.com/xi/SEC/R5/ResultRecording/1.0", "ResultRecord"), 1, new QName("http://labvantage.com/xi/SEC/R5/ResultRecording/1.0", "ResultRecord"), ResultRecord.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://labvantage.com/xi/SEC/R5/ResultRecording/1.0", "Result"));
        oper.setReturnClass(Result.class);
        oper.setReturnQName(new QName("http://labvantage.com/xi/SEC/R5/ResultRecording/1.0", "Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        ResultRecord_OUTBindingStub._operations[0] = oper;
    }

    public ResultRecord_OUTBindingStub() throws AxisFault {
        this(null);
    }

    public ResultRecord_OUTBindingStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public ResultRecord_OUTBindingStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://labvantage.com/xi/SEC/R5/ResultRecording/1.0", "Result");
        this.cachedSerQNames.add(qName);
        Class cls = Result.class;
        this.cachedSerClasses.add(cls);
        this.cachedSerFactories.add(beansf);
        this.cachedDeserFactories.add(beandf);
        qName = new QName("http://labvantage.com/xi/SEC/R5/ResultRecording/1.0", "ResultRecord");
        this.cachedSerQNames.add(qName);
        cls = ResultRecord.class;
        this.cachedSerClasses.add(cls);
        this.cachedSerFactories.add(beansf);
        this.cachedDeserFactories.add(beandf);
    }
    ...
    protected Call createCall() throws RemoteException {
        try {
            ...
            ResultRecord_OUTBindingStub resultRecord_OUTBindingStub = this;
            synchronized (resultRecord_OUTBindingStub) {
                if (this.firstCall()) {
    ...
    @Override
    public Result resultRecord_OUT(ResultRecord resultRecord) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "ResultRecord_OUT"));
        this.setRequestHeaders(_call);
        this.setAttachments(_call);
        Object _resp = _call.invoke(new Object[]{resultRecord});
    ...
    static {
        ResultRecord_OUTBindingStub._initOperationDesc1();
    }
}
