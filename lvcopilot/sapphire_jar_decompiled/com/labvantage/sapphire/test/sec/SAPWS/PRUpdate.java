...
public class PRUpdate
implements Serializable {
    private String ZSEC_DATA;
    private Object __equalsCalc = null;
    private boolean __hashCodeCalc = false;
    private static TypeDesc typeDesc = new TypeDesc(PRUpdate.class, true);

    public PRUpdate() {
    }

    public PRUpdate(String ZSEC_DATA) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PRUpdate)) {
            return false;
        }
        PRUpdate other = (PRUpdate)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    static {
        typeDesc.setXmlType(new QName("http://labvantage.com/xi/SEC/R5/PRUpdate/1.0", "PRUpdate"));
