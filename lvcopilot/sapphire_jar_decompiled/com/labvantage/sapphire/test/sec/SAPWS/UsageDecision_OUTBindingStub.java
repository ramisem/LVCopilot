...
public class UsageDecision_OUTBindingStub
extends Stub
implements UsageDecision_OUT {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.setName("UsageDecision_OUT");
        ParameterDesc param = new ParameterDesc(new QName("http://labvantage.com/xi/SEC/R5/UsageDecision/1.0", "UsageDecision"), 1, new QName("http://labvantage.com/xi/SEC/R5/UsageDecision/1.0", "UsageDecision"), UsageDecision.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://labvantage.com/xi/SEC/R5/UsageDecision/1.0", "Result"));
        oper.setReturnClass(Result.class);
        oper.setReturnQName(new QName("http://labvantage.com/xi/SEC/R5/UsageDecision/1.0", "Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        UsageDecision_OUTBindingStub._operations[0] = oper;
    }

    public UsageDecision_OUTBindingStub() throws AxisFault {
        this(null);
    }

    public UsageDecision_OUTBindingStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public UsageDecision_OUTBindingStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://labvantage.com/xi/SEC/R5/UsageDecision/1.0", "Result");
        this.cachedSerQNames.add(qName);
        Class cls = Result.class;
        this.cachedSerClasses.add(cls);
        this.cachedSerFactories.add(beansf);
        this.cachedDeserFactories.add(beandf);
        qName = new QName("http://labvantage.com/xi/SEC/R5/UsageDecision/1.0", "UsageDecision");
        this.cachedSerQNames.add(qName);
        cls = UsageDecision.class;
        this.cachedSerClasses.add(cls);
        this.cachedSerFactories.add(beansf);
        this.cachedDeserFactories.add(beandf);
    }
    ...
    protected Call createCall() throws RemoteException {
        try {
            ...
            UsageDecision_OUTBindingStub usageDecision_OUTBindingStub = this;
            synchronized (usageDecision_OUTBindingStub) {
                if (this.firstCall()) {
    ...
    @Override
    public Result usageDecision_OUT(UsageDecision usageDecision) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "UsageDecision_OUT"));
        this.setRequestHeaders(_call);
        this.setAttachments(_call);
        Object _resp = _call.invoke(new Object[]{usageDecision});
    ...
    static {
        UsageDecision_OUTBindingStub._initOperationDesc1();
    }
}
