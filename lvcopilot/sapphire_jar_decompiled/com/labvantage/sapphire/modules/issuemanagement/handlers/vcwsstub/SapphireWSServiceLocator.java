...
import com.labvantage.sapphire.modules.issuemanagement.handlers.vcwsstub.SapphireWSService;
import com.labvantage.sapphire.modules.issuemanagement.handlers.vcwsstub.SapphireWSSoapBindingStub;
...
implements SapphireWSService {
    private String SapphireWS_address = "https://vantagecare.labvantage.com/vc/services/SapphireWS?wsdl";
    ...
    public QName getServiceName() {
        return new QName("http://vmvctest1us.lims.com/vcstg/services/SapphireWS", "SapphireWSService");
    }

    public Iterator getPorts() {
        if (this.ports == null) {
            this.ports = new HashSet();
            this.ports.add(new QName("http://vmvctest1us.lims.com/vcstg/services/SapphireWS", "SapphireWS"));
        }
