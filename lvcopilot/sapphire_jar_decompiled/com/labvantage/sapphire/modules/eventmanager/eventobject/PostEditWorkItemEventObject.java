...
public class PostEditWorkItemEventObject
extends BaseSDCEventObject {
    public static final String EVENT_POSTEDITWORKITEM = "PostEditWorkItem";

    public PostEditWorkItemEventObject(String sdcid, PropertyList sdcProps, SDIData sdiData, PropertyList properties) {
        super(EVENT_POSTEDITWORKITEM, new Object[]{sdiData, properties, null}, sdcid, sdcProps, properties, sdiData);
    }
