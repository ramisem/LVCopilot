...
public class LinkedsdimaintElementRenderer
extends BaseElementRenderer {
    ...
    public ConfigReportContent report(String elementId, PropertyList elementProps, PropertyList refElementProps, PropertyDefinitionList defList, boolean reportAdvancedProperties, boolean reportHiddenColumns, boolean includeDiffReport) throws SapphireException {
        ...
        ConfigReportContent configReportContent = new ConfigReportContent(this.config, "linkedsdimaint element");
        PropertyList tabInfo = elementProps.getPropertyListNotNull("tab");
        String tabText = tabInfo.getProperty("text", elementId);
        configReportContent.startSubSection("Linkedsdimaint ( " + elementId + " , Tab: " + tabText + " ) ", "");
        ConfigReportContent summ = new ConfigReportContent(this.config, "Element");
        summ.startSubHeading("Columns", "");
        summ.append(this.renderColumnsInfo(elementProps, refElementProps, reportAdvancedProperties, includeDiffReport).toString());
        summ.append(this.renderColumnsRoleMatrix(elementProps, refElementProps, includeDiffReport).toString());
        summ.startSubHeading("Buttons", "");
        summ.append(this.renderButtonsInfo(elementProps, refElementProps, reportAdvancedProperties, includeDiffReport).toString());
        summ.append(this.renderButtonsRoleMatrix(elementProps, refElementProps, includeDiffReport).toString());
        configReportContent.appendSubSection(summ, "Linkedsdimaint ( " + elementId + " , Tab: " + tabText + " ) ", this.diffOnly);
    ...
    private ConfigReportContent renderColumnsInfo(PropertyList elementProps, PropertyList refElementProps, boolean reportAdvancedProeprties, boolean includeDiffReport) throws SapphireException {
        ConfigReportContent configReportContent = new ConfigReportContent(this.config, "linkedsdimaint element columns");
    ...
    private DataSet getColumnsInfo(PropertyList elementProps) {
        ...
        detailCols.addColumn("Lookuppage", 0);
        ...
        if (hasColumns) {
            ...
            for (PropertyList columnProps : columns) {
                ...
                link = columnProps.getProperty("lookuppage");
                detailCols.setString(row, "Lookuppage", ConfigReportContent.renderLink(link, this.sdisIncluded, this.frames, this.connection));
    ...
    private ConfigReportContent renderButtonsInfo(PropertyList elementProps, PropertyList refElementProps, boolean reportAdvancedProperties, boolean includeDiffReport) throws SapphireException {
        ConfigReportContent configReportContent = new ConfigReportContent(this.config, "linkedsdimaint element buttons");
    ...
    private ConfigReportContent renderColumnsRoleMatrix(PropertyList elementProps, PropertyList refElementProps, boolean includeDiffReport) {
        ConfigReportContent configReportContent = new ConfigReportContent(this.config, "linkedsdimaint element columns role matrix");
    ...
    private ConfigReportContent renderButtonsRoleMatrix(PropertyList elementProps, PropertyList refElementProps, boolean includeDiffReport) throws SapphireException {
        ConfigReportContent configReportContent = new ConfigReportContent(this.config, "linkedsdimaint element buttons role matrix");
