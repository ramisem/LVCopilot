...
import com.labvantage.sapphire.webservices.client.AttachmentTransport;
import com.labvantage.sapphire.webservices.client.BaseSECMessage;
import com.labvantage.sapphire.webservices.client.DataSetColumnTransport;
import com.labvantage.sapphire.webservices.client.DataSetRowTransport;
import com.labvantage.sapphire.webservices.client.DataSetTransport;
import com.labvantage.sapphire.webservices.client.EmpowerMessage;
...
import com.labvantage.sapphire.webservices.client.XMLMessage;
import java.net.URL;
...
implements SapphireWS_PortType {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.addParameter(param);
        param = new ParameterDesc(new QName("", "bindVars"), 1, new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_xsd_anyType"), Object[].class, false, false);
        oper.addParameter(param);
    ...
    private static void _initOperationDesc3() {
        ...
        oper.setReturnType(new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_soapenc_string"));
        oper.setReturnClass(String[].class);
    ...
    public SapphireWSSoapBindingStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_soapenc_string");
        ...
        qName = new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_tns1_DataSetColumnTransport");
        this.cachedSerQNames.add(qName);
        ...
        this.cachedSerFactories.add(new ArraySerializerFactory(qName, qName2));
        this.cachedDeserFactories.add(new ArrayDeserializerFactory());
        qName = new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_tns1_DataSetRowTransport");
        this.cachedSerQNames.add(qName);
        ...
        this.cachedSerFactories.add(new ArraySerializerFactory(qName, qName2));
        this.cachedDeserFactories.add(new ArrayDeserializerFactory());
        qName = new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_tns1_DataSetTransport");
        this.cachedSerQNames.add(qName);
        ...
        this.cachedSerFactories.add(new ArraySerializerFactory(qName, qName2));
        this.cachedDeserFactories.add(new ArrayDeserializerFactory());
        qName = new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_tns1_PropertyListTransport");
        this.cachedSerQNames.add(qName);
        ...
        this.cachedSerFactories.add(new ArraySerializerFactory(qName, qName2));
        this.cachedDeserFactories.add(new ArrayDeserializerFactory());
        qName = new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_tns1_PropertyValueTransport");
        this.cachedSerQNames.add(qName);
        ...
        this.cachedSerFactories.add(new ArraySerializerFactory(qName, qName2));
        this.cachedDeserFactories.add(new ArrayDeserializerFactory());
        qName = new QName("https://lt6491eu.lims.com:8443/labvantage/services/SapphireWS", "ArrayOf_xsd_anyType");
        this.cachedSerQNames.add(qName);
        cls = Object[].class;
        this.cachedSerClasses.add(cls);
