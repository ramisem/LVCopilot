...
extends BaseAction {
    ...
    public void processAction(PropertyList properties) throws SapphireException {
        ...
        String getItemNumbersSql = "SELECT itemkeyid1, itemkeyid2, s_samplingplanitemno FROM s_spitem WHERE s_samplingplanid = ? AND s_samplingplanversionid = ? AND itemsdcid = 'WorkItem' AND (" + getItemNumbersWhereFragment.substring(4) + ")";
        ...
        properties.setProperty(PROPERTY_SDCID, "LV_SamplingPlan");
        properties.setProperty(PROPERTY_KEYID1, samplingPlanId);
        properties.setProperty(PROPERTY_KEYID2, samplingPlanVersionId);
        properties.setProperty("linkid", "item");
        properties.setProperty("s_samplingplanitemno", itemNumbers.substring(1));
        this.getActionProcessor().processAction("EditSDIDetail", "1", properties);
    }
}
