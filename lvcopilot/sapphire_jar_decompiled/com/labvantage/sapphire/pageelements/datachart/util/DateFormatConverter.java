...
public class DateFormatConverter {
    private static final Map<String, String> tokenConversions = DateFormatConverter.prepareTokenConversions();
    private static final Map<String, String> localePrefixes = DateFormatConverter.prepareLocalePrefixes();
    ...
    public static String getPrefixForLocale(Locale locale) {
        ...
        if (result == null && (result = localePrefixes.get(localeString.substring(0, 2))) == null) {
            Locale parentLocale = new Locale(localeString.substring(0, 2));
            System.out.println("Unable to find prefix for " + locale + "(" + locale.getDisplayName() + ") or " + localeString.substring(0, 2) + "(" + parentLocale.getDisplayName() + ")");
            return "";
        }
        return result;
    }
