...
public class CombinedDomainCategoryPlotConfiguration
...
Serializable {
    ...
    public CombinedDomainCategoryPlotConfiguration(PropertyList combinedCategoryPlotProps, ConnectionInfo connectionInfo, PlotConfiguration parent) {
        super(combinedCategoryPlotProps, parent);
        PropertyListCollection plotCollection = combinedCategoryPlotProps.getCollectionNotNull("plotcollection");
        ...
        this.domainAxisConf = new AxisConfiguration(combinedCategoryPlotProps.getPropertyListNotNull("domainaxisprops"), connectionInfo, AxisConfiguration.AxisType.CATEGORY, this);
        PropertyList axisLocationProps = combinedCategoryPlotProps.getPropertyListNotNull("domainaxislocationprops");
    ...
    public CombinedDomainCategoryPlotConfiguration(CombinedDomainCategoryPlotConfiguration copy, PlotConfiguration parent) {
        super(copy, parent);
    ...
    public List<RendererConfiguration> getRendererConfList() {
        ...
        for (PlotConfiguration plotConf : this.plotConfList) {
            if (!plotConf.isPlotTypeSet() || plotConf.getPlotType() != PlotConfiguration.PlotType.CATEGORY_PLOT) continue;
            returnList.addAll(plotConf.getCategoryPlotConfiguration().getRendererConfList());
        }
        return returnList;
    }
    ...
    public SeriesGroupConfiguration getSeriesGroupConfiguration(String seriesGroupId) {
        ...
        for (PlotConfiguration plotConf : this.plotConfList) {
            if (!plotConf.isPlotTypeSet() || plotConf.getPlotType() != PlotConfiguration.PlotType.CATEGORY_PLOT) continue;
            returnConf = plotConf.getCategoryPlotConfiguration().getSeriesGroupConfiguration(seriesGroupId);
        }
        if (returnConf == null) {
    ...
    public RendererConfiguration getRendererConfiguration(String rendererId) {
        throw new UnsupportedOperationException("Combined domain Category plot configuration does not support this operation");
    }
