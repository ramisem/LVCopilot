...
public final class NumberArgumentConfiguration
extends BaseCustom
implements Serializable {
    private final ArgumentConfiguration parent;

    public NumberArgumentConfiguration(PropertyList numberArgumentProps, String connectionId, ArgumentConfiguration parent) {
        if (parent == null) {
            throw new IllegalArgumentException("Parent is null");
        }
        if (numberArgumentProps == null) {
