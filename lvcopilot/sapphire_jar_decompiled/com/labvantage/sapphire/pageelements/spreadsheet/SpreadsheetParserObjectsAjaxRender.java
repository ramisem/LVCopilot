...
public class SpreadsheetParserObjectsAjaxRender
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response, ServletContext servletContext) throws ServletException {
        ...
        if (props.length() > 0) {
            try {
                ...
                try {
                    String objectsHtml = SpreadsheetParser.getObjectsHtml(useprop, this.getConnectionId(), this.getTranslationProcessor(), request);
