...
public class QCCalcControl
extends QCCalcBaseAction {
    public static String LABVANTAGE_CVS_ID = "$Revision: 67311 $";
    public static final String PARAMETER_TYPE = "%Difference";
    ...
    public int processAction(String actionid, String actionversionid, HashMap props) {
        if (actionid.equals("QCCalcControl")) {
            return this.rc;
        }
        if (actionid.equals("QCCalcCtrlDifference")) {
            this.rc = this.doQCCalcControl(props);
        }
        return this.rc;
    }
    ...
    private int doQCCalcControl(HashMap props) {
        block53: {
            ...
            try {
                ...
                for (int k = 0; k < sdiDatasetHolder.size(); ++k) {
                    ...
                    for (int i = 0; i < dataitemList.size(); ++i) {
                        ...
                        try {
                            ...
                            this.logger.error("doQCCalcControl error", exc);
                        }
                ...
                this.logger.error("doQCCalcControl error", ex);
            }
        }
        return this.rc;
    }
    ...
    public DataSet addQCCalcDataItems(String qcBatchId, String bstId, String actionId, QueryProcessor qp) {
        ...
        String calcRule = "100 * ( [#;CURRENTITEM;#] - [AQC:QCParam|#;Concentration] ) / [AQC:QCParam|#;Concentration]";
